...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/daet@^4.7.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/daet@^4.7.0'
</script>
```
...
[Discover the release history by heading on over to the `HISTORY.md` file.](https://github.com/bevry/daet/blob/HEAD/HISTORY.md#files)
...
[Discover how to contribute via the `CONTRIBUTING.md` file.](https://github.com/bevry/daet/blob/HEAD/CONTRIBUTING.md#files)
...
-   [Benjamin Lupton](https://github.com/balupton) — [view contributions](https://github.com/bevry/daet/commits?author=balupton "View the GitHub contributions of Benjamin Lupton on repository bevry/daet")
